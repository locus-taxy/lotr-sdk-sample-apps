...
open class EasyTipView: UIView {
    ...
    fileprivate func isFrameValid(_ frame: CGRect, forRefViewFrame: CGRect, withinSuperviewFrame _: CGRect) -> Bool {
    ...
    fileprivate func drawText(_ bubbleFrame: CGRect, context _: CGContext) {
