...
internal enum Asset {
    ...
    internal static let checklistPhoto = ImageAsset(name: "checklistPhoto")
    internal static let checklistSignature = ImageAsset(name: "checklistSignature")
    internal static let clear = ImageAsset(name: "clear")
    internal static let scanImage = ImageAsset(name: "scanImage")
}
